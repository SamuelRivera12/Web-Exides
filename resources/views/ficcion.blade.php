...
<head>
    ...
    <title>TIENDA</title>
    <link rel="stylesheet" href="ficcion.css">
...
<body>
    ...
    <header class="header">
        <div class="menu container">
            <img class="logo" src="{{ asset('css/EXIDES.png') }}">
        ...
        <div class="header-content container">
            <div class="header-img">
                <img src="{{ asset('css/cienciaficcion.png') }}" alt="">
            </div>
        ...
        <div class="product-content">
            ...
            <div class="product">
                ...
                <div class="product-txt">
                    <h3>Juegos del hambre</h3>
                    <p class="precio">18,05€</p>
                    <a href="#" class="agregar-carrito btn-2" data-id="1">Agregar al carrito</a>
                </div>
            </div>
            <div class="product">
                <img src="{{ asset('css/ficcion2.jpg') }}" alt="">
                <div class="product-txt">
                    <h3>Divergente</h3>
                    <p>Ciencia Ficción</p>
            ...
            <div class="product">
                <img src="{{ asset('css/ficcion3.jpg') }}" alt="">
                <div class="product-txt">
            ...
            <div class="product">
                <img src="{{ asset('css/ficcion4.jpg') }}" alt="">
                <div class="product-txt">
            ...
            <div class="product">
                <img src="{{ asset('css/ficcion5.jpg') }}" alt="">
                <div class="product-txt">
                    <h3>Juego de tronos</h3>
                    <p class="precio">26,50€</p>
